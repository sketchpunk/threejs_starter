...
export default class Frustum{
    ...
    setPolar( lon, lat ){ quat.fromEuler( this.rot, -lat, lon, 0 ); return this; }

    getLineOfSight(){
        const dir = vec3.transformQuat( [0,0,0], [0,0,-1], this.rot );
        return [
            this.pos.slice(),
            vec3.scaleAndAdd( [0,0,0], this.pos, dir, this.far ),
        ];
    }
    // #endregion

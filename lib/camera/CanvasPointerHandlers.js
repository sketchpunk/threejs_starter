export default class CanvasPointerHandlers{
    ...
    _onWheel = e => {
        e.stopPropagation();
        if( this.onPointerWheel ) this.onPointerWheel( e, Math.sign( e.deltaY ) );
    };
    ...
    _onPointerDown = e => {
        ...
        if( this.onPointerDown ) this.onPointerDown( e, this._initCoord );
    ...
    _onPointerMove = e => {
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        if( this.onPointerMove ) this.onPointerMove( e, coord, delta, vel );
    };
    // #endregion

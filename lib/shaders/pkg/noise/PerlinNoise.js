...
export default { packageName: 'PerlinNoise', items:{
'fbmOptions':`
struct fbmOptions {
    float   seed;
    float   persistance;
...
'2D_fbm':`
float perlinNoise_fbm( vec2 p, fbmOptions opts ){
...
'3D_fbm':`
float perlinNoise_fbm( vec3 p, fbmOptions opts ){
    float persistance    = opts.persistance;
    float lacunarity     = opts.lacunarity;
    float redistribution = opts.redistribution;
    int octaves          = opts.octaves;

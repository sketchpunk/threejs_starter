...
export default class XRSlideLocomotion{
    ...
    constructor( xrMan, xrInput, target ){
        ...
        this.oscRateA   = 0.3;  // Slow to speed up
        this.oscRateB   = 0.8;  // Faster to speed down

        this.xAxis      = [0,0,0];
        this.yAxis      = [0,0,0];
        this.zAxis      = [0,0,0];

        this.zSpring    = new SpringIEFloat();
        this.xSpring    = new SpringIEFloat();
        this.tSpring    = new SpringIEFloat();
    ...
    handleRightCtrl( dt ){
        ...
        // Apply velocity
        this.zSpring.setOscPs( ((zScl !== 0 )? this.oscRateA : this.oscRateB) ).update( dt, zScl );
        this.xSpring.setOscPs( ((xScl !== 0 )? this.oscRateA : this.oscRateB) ).update( dt, xScl );
